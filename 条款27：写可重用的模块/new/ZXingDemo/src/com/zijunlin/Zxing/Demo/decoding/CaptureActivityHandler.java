...
import com.zijunlin.Zxing.Demo.callback.ScanCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  public CaptureActivityHandler(ScanCallback callback, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.return_scan_result:
        ...
        mCallback.setResult(Activity.RESULT_OK, (Intent) message.obj);
        mCallback.finish();
        break;
